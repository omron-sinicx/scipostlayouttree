...
def warmup_cosine_decay_scheduler(total_steps=11000, warmup_steps=500):
    cosine = L(CosineParamScheduler)(start_value=1.0, end_value=0.0)
    warmup = L(WarmupParamScheduler)(
        scheduler=cosine,
...
lr_warmup_cosine_decay_multiplier_24ep = warmup_cosine_decay_scheduler()
lr_warmup_cosine_decay_multiplier_24ep_bs8 = warmup_cosine_decay_scheduler(22000, 1000)
