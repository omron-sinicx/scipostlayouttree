...
from ..models.dino_layoutlmv3 import model
...
# train.init_checkpoint = "./dino_layoutlmv3_base_4scale_50ep.pth"
train.output_dir = "./output/dino_layoutlmv3_base_4scale_24ep"
