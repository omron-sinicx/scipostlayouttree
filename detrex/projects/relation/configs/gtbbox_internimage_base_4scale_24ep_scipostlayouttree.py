...
from .models.gtbbox_internimage import model
...
model.backbone.bottom_up.channels = 112
model.backbone.bottom_up.depths = [4, 4, 21, 4]
model.backbone.bottom_up.groups = [7, 14, 28, 56]
model.backbone.bottom_up.offset_scale = 1.0
model.backbone.bottom_up.drop_path_rate = 0.1
model.backbone.bottom_up.post_norm = True
