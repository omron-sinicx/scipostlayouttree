...
from .models.gtbbox_layoutlmv3 import model
...
lr_multiplier = get_config("common/coco_schedule.py").lr_warmup_cosine_decay_multiplier_24ep_bs8
train = get_config("common/train.py").train

# max training iterations
train.max_iter = 22000
...
train.init_checkpoint = "./layoutlmv3-base/pytorch_model.bin"
train.load_backbone_only = True
train.output_dir = "./output/layoutlmv3_base_24ep"

model.backbone.bottom_up.config_path = "./layoutlmv3-base/config.json"
