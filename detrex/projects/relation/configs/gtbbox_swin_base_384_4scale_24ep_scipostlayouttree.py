...
from .models.gtbbox_swin_base_384 import model
...
train.init_checkpoint = "./dino_swin_base_384_4scale_12ep.pth"
train.load_backbone_only = True
train.output_dir = "./output/dino_swin_base_384_4scale_24ep"
